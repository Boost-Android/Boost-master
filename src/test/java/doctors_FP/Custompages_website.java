...
public class Custompages_website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Custompages_website");
	DriverScript ds;
	String testCaseName="Custompages_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
