...
public class NewletterSubscription {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("NewletterSubscription");
	DriverScript ds;
	String testCaseName="NewletterSubscription";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
