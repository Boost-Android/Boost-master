...
public class Login {
	...
	Xls_Reader xls = new Xls_Reader(Constants.DATA_XLSX_Economyhotels);
	...
	public void testApp(Hashtable<String,String> data) throws IOException, InterruptedException {
		...
		test.log(LogStatus.INFO, "Starting the test       :    " + testCaseName + "     :     with test data: " + data.toString());
