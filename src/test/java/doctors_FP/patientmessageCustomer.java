...
public class patientmessageCustomer {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("patientmessageCustomer");
	DriverScript ds;
	String testCaseName="patientmessageCustomer";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
