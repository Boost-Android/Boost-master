...
public class Features_website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Features_website");
	DriverScript ds;
	String testCaseName="Features_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
