...
public class Service_catalouge_website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Service_catalouge_website");
	DriverScript ds;
	String testCaseName="Service_catalouge_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
