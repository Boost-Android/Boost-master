...
public class AppointmentBookedBusinessReport {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("AppointmentBookedBusinessReport");
	DriverScript ds;
	String testCaseName="AppointmentBookedBusinessReport";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
	...
	public void testApp(Hashtable<String,String> data) throws IOException, InterruptedException {
		...
		ds.executeKeywords(testCaseName,data, Constants.DATA_XLSX_Doctors); //passing the testcase that needs to be executed
