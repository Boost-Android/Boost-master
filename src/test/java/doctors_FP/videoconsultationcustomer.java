...
public class videoconsultationcustomer {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("videoconsultationcustomer");
	DriverScript ds;
	String testCaseName="videoconsultationcustomer";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
