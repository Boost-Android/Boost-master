...
public class AddCustomertestimonial {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Addpatienttestimonial");
	DriverScript ds;
	String testCaseName="Addpatienttestimonial";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
