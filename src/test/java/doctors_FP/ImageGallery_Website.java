...
public class ImageGallery_Website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("ImageGallery_Website");
	DriverScript ds;
	String testCaseName="ImageGallery_Website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
