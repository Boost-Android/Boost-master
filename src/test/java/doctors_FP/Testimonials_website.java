...
public class Testimonials_website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Testimonials_website");
	DriverScript ds;
	String testCaseName="Testimonials_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
