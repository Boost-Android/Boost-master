...
public class Redirect_to_website {
	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Redirect_to_website");
	DriverScript ds;
	String testCaseName="Redirect_to_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
