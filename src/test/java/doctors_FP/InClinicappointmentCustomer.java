...
public class InClinicappointmentCustomer {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("InClinicappointmentCustomer");
	DriverScript ds;
	String testCaseName="InClinicappointmentCustomer";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
