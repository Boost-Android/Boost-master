...
public class Inclinic_Appointment {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Inclinic_Appointment");
	DriverScript ds;
	String testCaseName="Inclinic_Appointment";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
