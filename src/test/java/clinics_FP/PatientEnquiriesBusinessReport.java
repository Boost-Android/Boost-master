...
public class PatientEnquiriesBusinessReport {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("PatientEnquiriesBusinessReport");
	DriverScript ds;
	String testCaseName="PatientEnquiriesBusinessReport";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
