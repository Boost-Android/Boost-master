...
public class TrackedcallsBusinessReport {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("TrackedcallsBusinessReport");
	DriverScript ds;
	String testCaseName="TrackedcallsBusinessReport";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
