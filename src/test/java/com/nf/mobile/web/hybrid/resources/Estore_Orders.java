...
public class Estore_Orders {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Test Zadinga App");
	DriverScript ds;
	String testCaseName="Estore_Orders";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
