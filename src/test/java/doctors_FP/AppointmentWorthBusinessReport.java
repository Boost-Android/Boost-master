...
public class AppointmentWorthBusinessReport {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("AppointmentWorthBusinessReport");
	DriverScript ds;
	String testCaseName="AppointmentWorthBusinessReport";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
