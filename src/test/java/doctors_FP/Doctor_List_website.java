...
public class Doctor_List_website {

	ExtentReports report = ExtentManager.getInstance();
	ExtentTest test = report.startTest("Doctor_List_website");
	DriverScript ds;
	String testCaseName="Doctor_List_website";//TEST CASE FOR WHICH THE DATA HAS TO BE READ
